...
[![Gitpod Ready-to-Code](https://img.shields.io/badge/Gitpod-Ready--to--Code-blue?logo=gitpod)](https://gitpod.io/#https://github.com/pilerou/node-mongo-collections-loader)
...
conventional-changelog -p node-mongo-collections-loader -i CHANGE_HISTORY.md -s
```
